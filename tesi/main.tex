...
\usepackage[fontsize=11.2pt]{scrextend}
\usepackage[utf8]{inputenc}
\usepackage[letterpaper, top=3.2cm, bottom=3.5cm, left=2.86cm, right=2.86cm]{geometry}
...
\todo[inline]{Aggiustare le ultime frasi}
